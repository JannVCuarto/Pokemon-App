   ...
   <table class="table table-hover shadow-lg">
      ...
      <tbody>
        <tr class="text-center" v-for="(user, index) in this.users" :key="index">
          ...
          <td>{{user.id}}</td>
          <td class="text-success fw-bold" v-if="user.email === this.loggedInEmail">This is Me!</td>
          <td class="text-success fw-bold" v-else>{{user.username}}</td>
          <td>
          <button
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header bg-primary">
                  <h5 class="modal-title text-white" id="exampleModalLabel" v-if="user.email === this.loggedInEmail">My liked Pokemons!</h5>
                  <h5 class="modal-title text-white" id="exampleModalLabel" v-else>Liked Pokemons by {{user.username}}</h5>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header bg-danger">
                  <h5 class="modal-title text-white" id="exampleModalLabel" v-if="user.email === this.loggedInEmail">My hated Pokemons!</h5>
                  <h5 class="modal-title text-white" id="exampleModalLabel" v-else>Hated Pokemons by {{user.username}}</h5>
                  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
